...
import TableList from '../../src/components/common/TableList/TableList';
import { list_view, update_view, update_multi_view, delete_view } from '../../src/context/actions/view';
import { pagination, sorting } from '../../src/utils/constants';
...
const TableComponent = () => {
  ...
  const _handleDelete = (rid) => {
    dispatch(delete_view({ status: 0, recordId: rid }));
  }
